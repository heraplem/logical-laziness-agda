\section{Lazy Cost Analysis via Functional Logic Programming}\label{sec:translation}
...
\subsection{The Base Language $B$}
...
\subsection{The Logic Language $L$}
...
\subsection{The Demand Translation}
