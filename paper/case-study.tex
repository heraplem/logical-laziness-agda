...
\cdc{Data} typeclass, which is required for free variables. The \cdc{List} type
models lazy lists: \cdc{Nil} is the empty list, and the \cdc{:~} operator
produces a new list by adding an element to the front of a (thunked) list.
