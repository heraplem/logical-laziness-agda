...
\begin{abstract}
  We describe a means of representing lazy programs in functional logic
  languages. Terms in this representation simultaneously implement two different
  semantics for lazy programs: the demand semantics of Bjerner and
  Holmstr{\"{o}}m and the clairvoyance semantics of Hackett and Hutton. As
  previous implementations of clairvoyance semantics were non-executable and
  programs that implement demand semantics are difficult to write by hand, this
  represents an advancement in the analysis of lazy programs. All of our results
