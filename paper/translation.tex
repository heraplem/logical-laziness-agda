...
logic variables with types corresponding to the types in \( \Gamma \), so \( \Gamma \) must be a parameter to the translation; we therefore denote it by \( \transD{t}{\Gamma} \).
