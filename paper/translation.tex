...
variables~(\(\tfreeZ\), also known as logical variables), nondeterministic
...
We show that the \transCname{} preserves the types of the original terms in
\(\LB\) and wraps them inside \texttt{M}:\ly{TODO: Fix $\Gamma$.}
\begin{theorem}
