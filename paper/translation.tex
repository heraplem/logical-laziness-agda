...
programming: logic variables \(\tfreeZ\), nondeterministic choice \(\tchooseZ\),
and failure \(\tfail\). Finally, we have a Boolean operator \(\tleZ\), which
indicates whether its left-hand operand lies below its right-hand operand in the
