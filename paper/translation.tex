...
We can give language $B$ a denotational semantics $\EE{t}{\gamma}$ for any term
$t$ under an evaluation context $\gamma$ by simply ignoring all lazy-evaluation
operators or computation cost:
...
We define a simple functional logic language $L$ instead of using an existing
formalization of one specific functional logic
