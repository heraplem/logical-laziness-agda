...
% demand
\newcommand{\ED}[2]{\SD\bbrackets{#1}({#2})}
% clairvoyance foldr
...
Note that \( \tfoldrZ \) is evaluated by first evaluting the list argument to a value and then iterating over that value.  The iteration is accomplished via the following auxiliary relation.
...
\begin{align*}
  \ED{x}{\gamma} &= (\braces{x \mapsto \gamma(x)}, 0) \\
  \ED{\ttrue}{\gamma} &= (\bot, 0) \\
  \ED{\tfalse}{\gamma} &= (\bot, 0) \\
  \ED{\tnil}{\gamma} &= (\bot, 0) \\
  \ED{\tcons{t_1}{t_2}}{\gamma} &= \ED{t_1}{\gamma} \sqcup \ED{t_2}{\gamma}
\end{align*}
...
\begin{lemma}
  If \( \TL{\Gamma}{t}{A} \) and \( \gamma \in \Approx{\Gamma} \), then \( \EL{\gamma}{t}{\relax} \).
\end{lemma}
...
\begin{center}
  \begin{prooftree}
    \hypo{\TL{\Gamma}{t}{\sundefined}}
    \infer1{\TL{\Gamma}{\ttranspose{t}}{\spair{\sundefined}{0}}}
  \end{prooftree}
\end{center}

\begin{center}
  \begin{prooftree}
    \hypo{\TL{\Gamma}{t}{\sthunk{\spair{v}{c}}}}
    \infer1{\TL{\Gamma}{\ttranspose{t}}{\spair{\sthunk{v}}{c}}}
  \end{prooftree}
\end{center}
...
The reduction behavior of \tfoldMZ\ is given in terms of yet another auxiliary relation.

\begin{center}
  \begin{prooftree}
    \hypo{\ELFM{\gamma}{x_1}{x_2}{t_1}{t_2}{v}{u}}
    \infer1{\EL{\gamma}{\tfoldM{x_1}{x_2}{t_1}{t_2}{v}}{u}}
  \end{prooftree}
\end{center}
...
\begin{center}
  \begin{prooftree}
    \hypo{\EL{\gamma}{t_2}{u}}
    \infer1{\ELFM{\gamma}{x_1}{x_2}{t_1}{t_2}{\varepsilon}{u}}
  \end{prooftree}
\end{center}
...
\begin{center}
  \begin{prooftree}
    ...
    \infer1{\ELFM{\gamma}{x_1}{x_2}{t_1}{t_2}{\scons{v_1}{\sundefined}}{u}}
  \end{prooftree}
\end{center}
...
\begin{center}
  \begin{prooftree}
    ...
    \infer2{\ELFM{\gamma}{x_1}{x_2}{t_1}{t_2}{\scons{v_1}{\sthunk{v_2}}}{\spair{v_4}{c_1 + c_2}}}
  \end{prooftree}
\end{center}
...
\begin{proof}
  ...
  \end{proof}
  \begin{itemize}
  \item \textbf{Case \rulename{L-Foldr-Nil}:}
    \begin{itemize}
    \item \(v_1 = \varepsilon\)
    ...
    \begin{center}
      \begin{prooftree}
        \hypo{\EC{\gamma}{t_2}{c}{v}}
        \infer1[\rulename{L-Foldr-Nil}]{\ECF{\gamma}{x_1}{x_2}{t_1}{t_2}{\snil}{c}{v}}
      \end{prooftree}
    \end{center}
  \end{itemize}
