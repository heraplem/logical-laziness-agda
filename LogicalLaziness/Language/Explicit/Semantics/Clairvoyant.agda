...
𝔻⟦ _ ⟧[ γ ]ᶜ = All.toList⁻ (All.map 𝔻[_]ᵗ γ)
...
≤𝔼⇒𝔻≺ᵗ : {v : 𝔼.⟦ α ⟧ᵗ} {v′ : ⟦ α ⟧ᵗ} → v′ ≤ᵗ 𝔼[ v ]ᵗ → 𝔻.⟦ α ⟧≺ᵗ v
≤𝔼⇒𝔻≺ᵗ {`Bool  } {false} {false    } ψ         = false
≤𝔼⇒𝔻≺ᵗ {`Bool  } {true } {true     } ψ         = true
≤𝔼⇒𝔻≺ᵗ {`T α   } {_    } {undefined} undefined = undefined
≤𝔼⇒𝔻≺ᵗ {`T α   } {_    } {thunk _  } (thunk ψ) = thunk (≤𝔼⇒𝔻≺ᵗ ψ)
≤𝔼⇒𝔻≺ᵗ {`List α} {[]   } {[]       } []        = []
≤𝔼⇒𝔻≺ᵗ {`List α} {_ ⸴ _} {v′ ∷ vs′ } (ψ₁ ∷ ψ₂) = ≤𝔼⇒𝔻≺ᵗ ψ₁ ∷ ≤𝔼⇒𝔻≺ᵗ ψ₂

𝔻𝔼ᵗ : {v : 𝔼.⟦ α ⟧ᵗ} {v′ : ⟦ α ⟧ᵗ} (ψ : v′ ≤ᵗ 𝔼[ v ]ᵗ) → 𝔻[ ≤𝔼⇒𝔻≺ᵗ ψ ]ᵗ ≡ v′
𝔻𝔼ᵗ {`Bool  } {false} {false} false     = refl
𝔻𝔼ᵗ {`Bool  } {true } {true } true      = refl
𝔻𝔼ᵗ {`T α   } {v    } {v′   } undefined = refl
𝔻𝔼ᵗ {`T α   } {v    } {v′   } (thunk ψ) = cong thunk (𝔻𝔼ᵗ ψ)
𝔻𝔼ᵗ {`List α} {∅    } {[]   } []        = refl
𝔻𝔼ᵗ {`List α} {_ ⸴ _} {_ ∷ _} (ψ₁ ∷ ψ₂) = cong₂ _∷_ (𝔻𝔼ᵗ ψ₁) (𝔻𝔼ᵗ ψ₂)

≤𝔼⇒𝔻≺ᶜ : {γ : 𝔼.⟦ Γ ⟧ᶜ} {γ′ : ⟦ Γ ⟧ᶜ} → γ′ ≤ᶜ 𝔼[ γ ]ᶜ → 𝔻.⟦ Γ ⟧≺ᶜ γ
≤𝔼⇒𝔻≺ᶜ {∅    } {∅    } ∅         = ∅
≤𝔼⇒𝔻≺ᶜ {_ ⸴ _} {_ ⸴ _} (ψ₁ ⸴ ψ₂) = ≤𝔼⇒𝔻≺ᶜ ψ₁ ⸴ ≤𝔼⇒𝔻≺ᵗ ψ₂

𝔻𝔼ᶜ : {γ : 𝔼.⟦ Γ ⟧ᶜ} {γ′ : ⟦ Γ ⟧ᶜ} (ψ : γ′ ≤ᶜ 𝔼[ γ ]ᶜ) → 𝔻[ ≤𝔼⇒𝔻≺ᶜ ψ ]ᶜ ≡ γ′
𝔻𝔼ᶜ {∅    } {∅    } {∅    } ∅         = refl
𝔻𝔼ᶜ {_ ⸴ _} {_ ⸴ _} {_ ⸴ _} (ψ₁ ⸴ ψ₂) = cong₂ _⸴_ (𝔻𝔼ᶜ ψ₁) (𝔻𝔼ᵗ ψ₂)
