...
general-purpose logic language. This shows that the logical demand functions
trade off performance for simplicity. However, the performance is still useful
for cost analysis. We discuss this in more details in \cref{sec:limitations}.
